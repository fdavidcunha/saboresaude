                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6"> 
                                <div class="dishes-item-container">
                                    ...
                                    <div class="img-frame">
                                        <!-- Image -->
                                        <img src="/res/site/img/dish/dish5.jpg" class="img-responsive" alt="" />
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="dishes-item-container">
                                    ...
                                    <div class="img-frame">
                                        <!-- Image -->
                                        <img src="/res/site/img/dish/dish6.jpg" class="img-responsive" alt="" />
                                        <!-- Block for on hover effect to image -->
                                        <div class="img-frame-hover">
                                            <!-- Hover Icon -->
                                            <a href="#"><i class="fa fa-cutlery"></i></a>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="dishes-item-container">
                                    ...
                                    <div class="img-frame">
                                        <!-- Image -->
                                        <img src="/res/site/img/dish/dish7.jpg" class="img-responsive" alt="" />
                                        <!-- Block for on hover effect to image -->
                                        <div class="img-frame-hover">
                                            <!-- Hover Icon -->
                                            <a href="#"><i class="fa fa-cutlery"></i></a>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="dishes-item-container">
                                    ...
                                    <div class="img-frame">
                                        <!-- Image -->
                                        <img src="/res/site/img/dish/dish8.jpg" class="img-responsive" alt="" />
                                        <!-- Block for on hover effect to image -->
                                        <div class="img-frame-hover">
                                            <!-- Hover Icon -->
                                            <a href="#"><i class="fa fa-cutlery"></i></a>
                        ...
                        <div class="menu-container">
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <div class="menu-head">
                                        <!-- Image for menu item -->
                                        <img class="menu-img img-responsive img-thumbnail" src="/res/site/img/menu/menu1.jpg" alt="" />
                                        <!-- Menu title / Heading -->
                                        <h3>Seafood</h3>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <div class="menu-head">
                                        <!-- Image for menu item -->
                                        <img class="menu-img img-responsive img-thumbnail" src="/res/site/img/menu/menu2.jpg" alt="" />
                                        <!-- Menu title / Heading -->
                                        <h3>Chicken</h3>
                                        <!-- Border for above heading -->
                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <div class="menu-head">
                                        <!-- Image for menu item -->
                                        <img class="menu-img img-responsive img-thumbnail" src="/res/site/img/menu/menu3.jpg" alt="" />
                                        <!-- Menu title / Heading -->
                                        <h3>Dessert</h3>
                                        <!-- Border for above heading -->
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <div class="pricing-item">
                                    <!-- Image -->
                                    <a href="#"><img class="img-responsive img-thumbnail" src="/res/site/img/dish/dish3.jpg" alt="" /></a>
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <div class="pricing-item">
                                    <!-- Image -->
                                    <a href="#"><img class="img-responsive img-thumbnail" src="/res/site/img/dish/dish2.jpg" alt="" /></a>
                                    <!-- Pricing item details -->
                                    <div class="pricing-item-details">
                                        <!-- Heading -->
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <div class="pricing-item">
                                    <!-- Image -->
                                    <a href="#"><img class="img-responsive img-thumbnail" src="/res/site/img/dish/dish4.jpg" alt="" /></a>
                                    <!-- Pricing item details -->
                                    <div class="pricing-item-details">
                                        <!-- Heading -->
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <div class="pricing-item">
                                    <!-- Image -->
                                    <a href="#"><img class="img-responsive img-thumbnail" src="/res/site/img/dish/dish1.jpg" alt="" /></a>
                                    <!-- Pricing item details -->
                                    <div class="pricing-item-details">
                                        <!-- Heading -->
                                ...
                                <div class="flexslider-recent flexslider">
                                    <ul class="slides">
                                        <li>
                                            ...
                                            <img class="img-responsive" src="/res/site/img/dish/dish9.jpg" alt="" />
                                            <!-- Slide content -->
                                        ...
                                        <li>
                                            <!-- Image for background -->
                                            <img class="img-responsive" src="/res/site/img/dish/dish10.jpg" alt="" />
                                            <!-- Slide content -->
                                            <div class="slider-content">
                                                <!-- Heading -->
                                        ...
                                        <li>
                                            <!-- Image for background -->
                                            <img class="img-responsive" src="/res/site/img/dish/dish11.jpg" alt="" />
                                            <!-- Slide content -->
                                            <div class="slider-content">
                                                <!-- Heading -->
                                    ...
                                    <ul class="slides">
                                        <li>
                                            ...
                                            <div class="testimonial-item">
                                                ...
                                                <!-- Heading with image -->
                                                <h4><img class="img-responsive img-circle" src="/res/site/img/user.jpg" alt="" /> Jhon Doe<span>, your designation</span></h4>
                                                <div class="clearfix"></div>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="testimonial-item">
                                                ...
                                                <!-- Heading with image -->
                                                <h4><img class="img-responsive img-circle" src="/res/site/img/user.jpg" alt="" /> Marten<span>, your designation</span></h4>
                                                <div class="clearfix"></div>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="testimonial-item">
                                                ...
                                                <!-- Heading with image -->
                                                <h4><img class="img-responsive img-circle" src="/res/site/img/user.jpg" alt="" /> Katrina Doe<span>, your designation</span></h4>
                                                <div class="clearfix"></div>
                                            </div>
                                        </li>
                                    </ul>
